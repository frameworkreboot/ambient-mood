...
const sidebarVariants = cva("h-full transition-all duration-300 ease-in-out overflow-hidden", {
  variants: {
    open: {
      true: "w-80",
      false: "w-0",
...
const SidebarTriggerNew = React.forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement>>(
  ({ className, ...props }, ref) => {
...
SidebarTriggerNew.displayName = "SidebarTriggerNew"
